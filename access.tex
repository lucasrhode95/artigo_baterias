...
\begin{document}
    ...
    \author{
    	\uppercase{Marcos Aurelio Izumida Martins}\authorrefmark{1}, \IEEEmembership{Senior Member, IEEE}
...
%    \end{equation}
    ...
    \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/izumida.jpeg}}]{MARCOS AURELIO IZUMIDA MARTINS}
	...
	\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/rhode.png}}]{LUCAS B. RHODE}
	...
	\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/almeida.jpeg}}]{ADRIANO BATISTA DE ALMEIDA}
