...
%    \end{equation}
%
%    By substituting \eqref{eq:ACC(dod)} in \eqref{eq:wn(s)} and considering $s \le 1$, the normalized wear density function becomes:
%    \small
%    \begin{equation}
